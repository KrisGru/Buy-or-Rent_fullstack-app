...
export default function SignUp({ dataUser, setDataUser }) {
  return (
  ...
  const handleSubmit = event => {
    ...
    .then(response => {
      switch (response.status) {
        ...
        case 500: throw new Error("all fields are required");
        default: console.log('fetch in SignUp')
      }})
    .then(response => {
    ...
    <div>
      ...
      <Form onSubmit={handleSubmit} >
        ...
        <div key="radioRegister" className="mb-3">
          ...
          <Form.Check inline label="User" name="group1" type='radio' value="user" id="radioUser" />
          <Form.Check inline label="Admin" name="group1" type="radio" value="admin" id="radioAdmin" />
        </div>
        <Button className="button darkBtn" type="submit">Register</Button>
      </Form>
    </div>
  )
}
    ...
    <div>
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group className="mb-3" controlId="passwordS">
          ...
          <Button className="button darkBtn" variant="primary" type="submit">Log in</Button>
      </Form>
    </div>
  )
}
